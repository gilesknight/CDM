...
ns.outfile = {'Tauwitchere_v2.csv';'Ewe_v2.csv';'Boundary_v2.csv';'Mundoo_v2.csv';'Goolwa_v2.csv';};
...
datearray = [datenum(2015,01,01):1/24:datenum(2016,01,01)];
...
for bb = 1:length(ns.outfile)
    ...
    for i = 1:length(ggg)
        data = tfv_readnetcdf(ncfile,'timestep',ggg(i));
        clear function
        
        disp(datestr(timesteps_all(ggg(i)),'dd/mm/yyyy HH:MM:SS'));
