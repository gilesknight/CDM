function plot2bb(xdata,ydata,xdata1,ydata1,opts,leg,ylimit)
...
plot(xdata,ydata,'color','b');hold on
plot(xdata1,ydata1,'color','k');hold on


plot([(min(xdata) - 100):1:(max(xdata) + 100)],0,'k');
