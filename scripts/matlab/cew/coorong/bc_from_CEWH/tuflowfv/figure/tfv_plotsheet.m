...
if strcmp(holding{1},'H') == 0
    ...
    cdata = data.(holding{1}) - data.cell_Zb;
...
[max_val,ind] = max(cdata);

disp(['Max Value: ',num2str(max_val),'  Min Value: ',num2str(min(cdata)),'  DZ:',num2str(data.cell_Zb(ind))]);
