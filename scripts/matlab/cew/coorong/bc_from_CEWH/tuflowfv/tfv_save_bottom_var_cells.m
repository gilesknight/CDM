...
if strcmp(varname,'WQ_OXY_OXY') == 1
...
if strcmp(varname,'WQ_DIAG_PHY_KARLO_FNIT') == 1
    proc.bottom(proc.bottom <= 0.6) = 0;
    proc.bottom(proc.bottom > 0.6) = 1;
end

if strcmp(varname,'WQ_DIAG_PHY_KARLO_FT') == 1
    proc.bottom(proc.bottom <= 0.8) = 0;
    proc.bottom(proc.bottom > 0.8) = 1;
end

if strcmp(varname,'WQ_DIAG_PHY_KARLO_FSAL') == 1
    proc.bottom(proc.bottom <= 0.8) = 0;
    proc.bottom(proc.bottom > 0.8) = 1;
end
