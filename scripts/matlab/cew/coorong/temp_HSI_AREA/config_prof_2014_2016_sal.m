...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\012_ORH_2014_2016_1\Point\';
...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\012_ORH_2014_2016_Needles\Point\';
% ____________________________________________________________Configuration
...
ncfile(1).name = 'I:\Lowerlakes\Coorong Weir Simulations\012_ORH_2014_2016_1\Output\coorong.nc';
ncfile(1).symbol = {'-';'--'};
ncfile(1).colour = {'k','k'}; % Surface and Bottom
ncfile(1).legend = 'ORH';
ncfile(1).translate = 1;

ncfile(2).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_ORH_2014_2016_Needles_Sill\Output\coorong.nc';
ncfile(2).symbol = {'-';'--'};
ncfile(2).colour = {'b','b'}; % Surface and Bottom
ncfile(2).legend = 'ORH Needles 0.4';
ncfile(2).translate = 1;
% 
% ncfile(3).name = 'I:\Lowerlakes\Coorong Weir Simulations\012_Weir_2_SC40_Parnka\Output\coorong.nc';
% ncfile(3).symbol = {'-';'--'};
% ncfile(3).colour = {'g','g'}; % Surface and Bottom
% ncfile(3).legend = 'Parnka';
% ncfile(3).translate = 1;
% 
% ncfile(4).name = 'I:\Lowerlakes\Coorong Weir Simulations\012_Weir_3_SC40_noWeir\Output\coorong.nc';
% ncfile(4).symbol = {'-';'--'};
% ncfile(4).colour = {'m','m'}; % Surface and Bottom
% ncfile(4).legend = 'No Weir';
...
def.datearray = datenum(yr,01:6:37,01);
...
def.fieldcolour = {'b','b'}; % Cell with same number of levels
