...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\010_Ruppia_2015_2016_Matt_BB\Region\';
% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = 'I:\Lowerlakes\Coorong Only Simulations\010_Ruppia_2015_2016_Matt\Output\coorong.nc';
 ncfile(1).symbol = {'-';'--'};
