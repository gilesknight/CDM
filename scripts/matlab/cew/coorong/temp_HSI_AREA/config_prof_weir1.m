...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\Weir_Final\Weir_Option_2\Point\';
...
ncfile(1).symbol = {'-';'--'};
ncfile(1).colour = {'k','k'}; % Surface and Bottom
ncfile(1).legend = 'Parnka Sept.';
ncfile(1).translate = 1;

ncfile(2).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_Weir_2_SC40_Parnka\Output\coorong.nc';
ncfile(2).symbol = {'-';'--'};
ncfile(2).colour = {'r','r'}; % Surface and Bottom
ncfile(2).legend = 'Parnka Aug.';
ncfile(2).translate = 1;

ncfile(3).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_Weir_13_Parnka_SC55_J\Output\coorong.nc';
ncfile(3).symbol = {'-';'--'};
ncfile(3).colour = {'b','b'}; % Surface and Bottom
ncfile(3).legend = 'Parnka July.';
