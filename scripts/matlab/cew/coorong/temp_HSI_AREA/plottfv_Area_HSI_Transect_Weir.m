...
for kk = 1:length(years)
    ...
    for bb = 1:length(group)
        ...
        for i = 1:length(group(bb).scenarios)
            ...
            if exist(['D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\',group(bb).scenarios{i},'\Sheets\',num2str(years(kk)),'\HSI_sexual.mat'],'file');
                
                load(['D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\',group(bb).scenarios{i},'\Sheets\',num2str(years(kk)),'\HSI_sexual.mat']);
        ...
        set(leg,'fontsize',6);
        ylabel('$\overline{HSI}$ (0-1)', 'Interpreter', 'latex','fontsize',6);
        ...
        if ~exist(['D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\Weir_Final\Transect\',num2str(years(kk)),'\',savenames{bb},'\'],'dir')
            mkdir(['D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\Weir_Final\Transect\',num2str(years(kk)),'\',savenames{bb},'\']);
        end
