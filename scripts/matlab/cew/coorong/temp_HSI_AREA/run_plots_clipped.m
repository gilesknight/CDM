...
%   plottfv_averaged_4_panel_coorong_sheet_inserts_lims_1; 
%   plottfv_averaged_4_panel_coorong_sheet_inserts_lims_2; 
%   plottfv_averaged_4_panel_coorong_sheet_inserts_lims_3; 
%   plottfv_averaged_4_panel_coorong_sheet_inserts_lims_4; 
%   plottfv_averaged_4_panel_coorong_sheet_inserts_lims_5; 
% 
 hsi1= load('D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\008_2015\Sheets\1_adult\HSI_1.mat')
 hsi2= load('D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\008_2015\Sheets\2_flower\HSI_2.mat')
 hsi3= load('D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\008_2015\Sheets\3_seed\HSI_3.mat')
 hsi4= load('D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\008_2015\Sheets\4_turion\HSI_4.mat')
 hsi5= load('D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\008_2015\Sheets\5_sprout\HSI_5.mat')
...
outdir = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\008_2015\Sheets\Clipped\';
chsi=1.0;
...
axes('position',[ 0.62 0.45  0.45 0.45]);
    patFig1 = patch('faces',faces,'vertices',vert,'FaceVertexCData',min_cdata);shading flat
    set(gca,'box','on');
    set(findobj(gca,'type','surface'),...
        'FaceLighting','phong',...
    ...
    axis equal
    axis off;%set(gca,'xticklabel',[],'yticklabel',[]);
    xlim([3.5824e+05 3.7139e+05]);
    ylim([6.0103e+06 6.0214e+06]);
...
axes('position',[ 0.45 0.10  0.5 0.9]);
%axes('position',[0.5 0.33 0.5 .33]);
    patFig1 = patch('faces',faces,'vertices',vert,'FaceVertexCData',min_cdata);shading flat
    set(gca,'box','on');
    set(findobj(gca,'type','surface'),...
