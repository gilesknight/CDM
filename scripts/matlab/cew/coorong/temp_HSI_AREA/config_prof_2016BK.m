...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\010_Ruppia_2016_2017_1\Point\';
...
ncfile(1).name = 'I:\Lowerlakes\Coorong Only Simulations\Scenarios\010_Ruppia_2016_2017_1\Output\coorong.nc';
ncfile(1).symbol = {'-';'--'};
ncfile(1).colour = {'k','k'}; % Surface and Bottom
ncfile(1).legend = '009';
ncfile(1).translate = 1;
