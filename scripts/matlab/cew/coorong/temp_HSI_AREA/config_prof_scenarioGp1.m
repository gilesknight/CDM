...
def.cAxis(3).value = [0 125];
def.cAxis(4).value = [0 20];
def.cAxis(5).value = [0 1];
def.cAxis(6).value = [0 75];
...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\010_Scenarios\PointGroup1\';
...
ncfile(1).legend = 'Barrage 755GL (Base)';
ncfile(1).translate = 1;

ncfile(2).name = 'I:\Lowerlakes\Coorong Only Simulations\Scenarios\011_Ruppia_2015_2016_2_B0fin\Output\coorong.nc';
ncfile(2).symbol = {'-';'--'};
ncfile(2).colour = {'g','g'}; % Surface and Bottom
ncfile(2).legend = 'Barrage 0GL';
ncfile(2).translate = 1;

ncfile(3).name = 'I:\Lowerlakes\Coorong Only Simulations\Scenarios\010_Ruppia_2015_2016_3_BTau\Output\coorong.nc';
ncfile(3).symbol = {'-';'--'};
ncfile(3).colour = {'r','r'}; % Surface and Bottom
ncfile(3).legend = 'Barrage 6000GL (Tau90%)';
ncfile(3).translate = 1;

ncfile(4).name = 'I:\Lowerlakes\Coorong Only Simulations\Scenarios\010_Ruppia_2015_2016_4_BGoo\Output\coorong.nc';
ncfile(4).symbol = {'-';'--'};
ncfile(4).colour = {'c','c'}; % Surface and Bottom
ncfile(4).legend = 'Barrage 6000GL (Tau50%)';
...
ncfile(5).legend = 'Barrage 226GL + SC108GL';
