...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\010_Scenarios\RegionGroup1\';
% ____________________________________________________________Configuration
...
ncfile(2).name = 'I:\Lowerlakes\Coorong Only Simulations\Scenarios\010_Ruppia_2015_2016_2_B0\Output\coorong.nc';
 ncfile(2).symbol = {'-';'--'};
