...
[pt_id,geo_x, geo_y] = searchnearest(curt,geo);


%--% Load cData

%--% Calulate Grid
[gridmesh,matching] = calculategrid(data,geo,pt_id,varname);
...
%-------------------------------------------------------------------------%
function [pt_id,out_x, out_y] = searchnearest(curt,geo)
...
%-------------------------------------------------------------------------%
function [gridmesh,matching] = calculategrid(data,geo,pt_id,varname)
