...
function popupmessage(f,textfile,titlename,command);
...
%-----------------------------------
function h=addTextBox(f,strings)
...
bpos=getOKPos(f);
h=uicontrol(f,'style','pushbutton','position',bpos,'string',btext,'tag','okaybutton','visible','off');
