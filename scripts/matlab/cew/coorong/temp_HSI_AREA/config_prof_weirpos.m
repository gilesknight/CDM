...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\Weir_Final\Weir_Position\Point\';
...
ncfile(2).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_Weir_7_SC55_Needles\Output\coorong.nc';
ncfile(2).symbol = {'-';'--'};
ncfile(2).colour = {'r','r'}; % Surface and Bottom
ncfile(2).legend = 'Needles SC55';
ncfile(2).translate = 1;

ncfile(3).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_Weir_8_SC55_Parnka\Output\coorong.nc';
ncfile(3).symbol = {'-';'--'};
ncfile(3).colour = {'b','b'}; % Surface and Bottom
ncfile(3).legend = 'Parnka SC55';
ncfile(3).translate = 1;
% 
ncfile(4).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_Weir_9_SC55_noWeir\Output\coorong.nc';
ncfile(4).symbol = {'-';'--'};
ncfile(4).colour = {'g','g'}; % Surface and Bottom
ncfile(4).legend = 'No Weir SC55';
