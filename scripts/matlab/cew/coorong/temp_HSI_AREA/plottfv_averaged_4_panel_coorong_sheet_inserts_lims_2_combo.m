...
%axes('position',[0.5 0.33 0.5 .33]);
    ...
    xlim([3.1008e+05 3.6120e+05]);
    ylim([6.0275e+06 6.0704e+06]);
    text(0.31,0.75,'HSI (flower)','Units','Normalized','fontsize',12);
...
saveas(gcf,[outdir,'HSI_flower_north.png']);
...
%axes('position',[0.5 0.33 0.5 .33]);
    ...
    xlim([3.4280e+05 3.9398e+05]);
    ylim([5.9896e+06 6.0326e+06]);
    text(0.31,0.95,'HSI (flower)','Units','Normalized','fontsize',12);
...
saveas(gcf,[outdir,'HSI_flower_south.png']);
save([outdir,'HSI_flower_south.mat'],'min_cdata','-mat');

export_area([outdir,'HSI_flower_south.csv'],min_cdata,Area);
