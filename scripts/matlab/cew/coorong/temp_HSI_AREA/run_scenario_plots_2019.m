...
year_array = [2014 2014 2014 2014 2014 2015 2015 2015 2015 2015];% 2014 2014 2014 2015 2015 2015 2015];%,2015,2015];

day_array = [80 100 120 140 160 80 100 120 140 160];
average_array = [60 80 100 120 140 60 80 100 120 140]; 
...
for i = 1:length(scenarios)
    ...
    if exist(filename,'file')
        ...
        if f.bytes > min_size
            ...
            outdir_malg_f = ['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\malg\'];
            plottfv_averaged_4_panel_coorong_sheet_inserts_malg_f(filename,outdir_malg_f,year_array(i));
            
            
            % Plots to the sheets directory
            outdir_lim1_f = ['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\1_adult_new\'];
            outdir_lim2_f = ['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\2_flower_new\'];
            outdir_lim3_f = ['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\3_seed_new\'];
            outdir_lim4_f = ['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\4_turion_new\'];
            outdir_lim5_f = ['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\5_sprout_new\'];
            
            
            plottfv_averaged_4_panel_coorong_sheet_inserts_lims_1_combo_f(filename,outdir_lim1_f,scenarios{i},year_array(i),day_array(i),average_array(i));
            plottfv_averaged_4_panel_coorong_sheet_inserts_lims_2_combo_f(filename,outdir_lim2_f,scenarios{i},year_array(i),day_array(i),average_array(i));
            plottfv_averaged_4_panel_coorong_sheet_inserts_lims_3_combo_f(filename,outdir_lim3_f,scenarios{i},year_array(i),day_array(i),average_array(i));
            plottfv_averaged_4_panel_coorong_sheet_inserts_lims_4_combo_f(filename,outdir_lim4_f,scenarios{i},year_array(i),day_array(i),average_array(i));
            plottfv_averaged_4_panel_coorong_sheet_inserts_lims_5_combo_f(filename,outdir_lim5_f,scenarios{i},year_array(i),day_array(i),average_array(i));
            
            
            % The stand alone plot
            
            hsi1= load(['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\1_adult_new\HSI_adult.mat']);
            hsi2= load(['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\2_flower_new\HSI_flower.mat']);
            hsi3= load(['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\3_seed_new\HSI_seed.mat']);
            hsi4= load(['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\4_turion_new\HSI_turion.mat']);
            hsi5= load(['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\5_sprout_new\HSI_sprout.mat']);
            
            
            outdir = ['R:\Coorong_Area\',scenarios{i},'_',num2str(day_array(i)),'\Sheets\',num2str(year_array(i)),'\'];
