...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\013_Weir_SC70\Point\';
...
ncfile(1).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_Weir_1_SC40_Needles\Output\coorong.nc';
ncfile(1).symbol = {'-';'--'};
ncfile(1).colour = {'k','k'}; % Surface and Bottom
ncfile(1).legend = 'Needles SC40';
ncfile(1).translate = 1;

ncfile(2).name = 'I:\Lowerlakes\Coorong Weir Simulations\013_Weir_2_SC40_Parnka_Fixed_TS\Output\coorong.nc';
ncfile(2).symbol = {'-';'--'};
ncfile(2).colour = {'r','r'}; % Surface and Bottom
ncfile(2).legend = 'Parnka SC40';
ncfile(2).translate = 1;

ncfile(3).name = 'I:\Lowerlakes\Coorong Weir Simulations\012_Weir_3_SC40_noWeir\Output\coorong.nc';
ncfile(3).symbol = {'-';'--'};
ncfile(3).colour = {'b','b'}; % Surface and Bottom
ncfile(3).legend = 'No Weir SC40';
ncfile(3).translate = 1;

ncfile(4).name = 'I:\Lowerlakes\Coorong Weir Simulations\012_ORH_2014_2016_1\Output\coorong.nc';
ncfile(4).symbol = {'-';'--'};
