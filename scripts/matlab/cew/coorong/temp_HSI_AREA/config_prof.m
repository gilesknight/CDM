...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\010_Ruppia_2015_2016_1\Point\';
...
ncfile(2).name = 'I:\Lowerlakes\Coorong Only Simulations\010_Ruppia_2015_2016_Matt\Output\coorong.nc';
ncfile(2).symbol = {'-';'--'};
ncfile(2).colour = {'r','r'}; % Surface and Bottom
ncfile(2).legend = '010_v3';
