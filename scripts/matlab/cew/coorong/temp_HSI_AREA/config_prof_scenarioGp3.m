...
outputdirectory = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\BB\010_Scenarios\PointGroup3\';
...
ncfile(3).name = 'I:\Lowerlakes\Coorong Only Simulations\Scenarios\010_Ruppia_2015_2016_9_SC40_2Nut\Output\coorong.nc';
ncfile(3).symbol = {'-';'--'};
...
ncfile(4).name = 'I:\Lowerlakes\Coorong Only Simulations\Scenarios\010_Ruppia_2015_2016_11_lgt\Output\coorong.nc';
ncfile(4).symbol = {'-';'--'};
ncfile(4).colour = {'b','b'}; % Surface and Bottom
ncfile(4).legend = 'Salt Creek 6GL + NoTurbidity';
ncfile(4).translate = 1;
