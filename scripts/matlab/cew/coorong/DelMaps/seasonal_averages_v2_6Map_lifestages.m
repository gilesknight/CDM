...
pos(1).a = [0.00 0.55 0.33 0.4];
pos(2).a = [0.33 0.55 0.33 0.4];
pos(3).a = [0.66 0.55 0.33 0.4];
% pos(4).a = [0.75 0.55 0.25 0.4];

pos(4).a = [0.0 0.1 0.33 0.4];
pos(5).a = [0.33 0.1 0.33 0.4];
pos(6).a = [0.66 0.1 0.33 0.4];
% pos(8).a = [0.75 0.1 0.25 0.4];


pos(1).b = [0.00  0.55 0.2 0.2];
pos(2).b = [0.33 0.55 0.2 0.2];
pos(3).b = [0.66 0.55 0.2 0.2];
% pos(4).b = [0.75 0.55 0.2 0.2];

pos(4).b = [0.00 0.1 0.2 0.2];
pos(5).b = [0.33 0.1 0.2 0.2];
pos(6).b = [0.66 0.1 0.2 0.2];
...
basedata.Flower = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_Base_20140101_20170101\Sheets\2014\2_flower_new\HSI_flower.mat');
basedata.Seed = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_Base_20140101_20170101\Sheets\2014\3_seed_new\HSI_seed.mat');
basedata.Turion = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_Base_20140101_20170101\Sheets\2014\4_turion_new\HSI_turion.mat');
basedata.Sprout = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_Base_20140101_20170101\Sheets\2014\5_sprout_new\HSI_sprout.mat');
basedata.HSI = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_Base_20140101_20170101\Sheets\2014\HSI_sexual.mat');

compdata.Adult = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_SLR_02_20140101_20170101\Sheets\2014\1_adult_new\HSI_adult.mat');
compdata.Flower = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_SLR_02_20140101_20170101\Sheets\2014\2_flower_new\HSI_flower.mat');
compdata.Seed = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_SLR_02_20140101_20170101\Sheets\2014\3_seed_new\HSI_seed.mat');
compdata.Turion = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_SLR_02_20140101_20170101\Sheets\2014\4_turion_new\HSI_turion.mat');
compdata.Sprout = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_SLR_02_20140101_20170101\Sheets\2014\5_sprout_new\HSI_sprout.mat');
compdata.HSI = load('Y:\Coorong Report\Ruppia_Life_Stages\ORH_SLR_02_20140101_20170101\Sheets\2014\HSI_sexual.mat');
...
figure('position',[750.333333333333          118.333333333333          1201.33333333333                      1088]);
...
%     end
    ...
    patFig = patch('faces',faces','vertices',[XX YY],'FaceVertexCData',basedata.(theorder{i}).min_cdata);shading flat
...
%     
    ...
    saveas(gcf,[outdir,'Base_HSI_raw.png']);close;
...
%     end
    ...
    patFig = patch('faces',faces','vertices',[XX YY],'FaceVertexCData',compdata.(theorder{i}).min_cdata);shading flat
    set(gca,'box','on');hold on
%     if themonths(i).year(1) > 1995
        mapshow(shp,'facecolor','none','edgecolor','k');
%     else
...
%     
    ...
    saveas(gcf,[outdir,'SLR_HSI_raw.png']);close;
...
for i = 1:length(theorder)
    ...
    theDel = compdata.(theorder{i}).min_cdata - basedata.(theorder{i}).min_cdata;
...
% if ~do_crit
    saveas(gcf,[outdir,'SLR_HSI_Delmap.png']);close;
