...
themonths(3).val = [12 2];
themonths(3).year = [2014 2015];
...
pos(1).a = [0.00 0.1 0.33 0.8];
pos(2).a = [0.33 0.1 0.33 0.8];
...
pos(1).b = [-0.1  0.15 0.4 0.4];
pos(2).b = [0.23 0.15 0.4 0.4];
...
figure('position',[594.333333333333          546.333333333333          1573.33333333333          704.666666666667]);
