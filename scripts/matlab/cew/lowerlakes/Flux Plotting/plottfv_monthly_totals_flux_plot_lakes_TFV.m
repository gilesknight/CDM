...
% mod(1).mat = 'D:\Studysites\Lowerlakes\019_obs_noAED_WS20_SC_Flow_off\Output\Flux.mat';
% mod(1).name = 'Obs v19 W10 20';
% mod(1).color = 'b';
...
% mod(3).mat = 'D:\Studysites\Lowerlakes\CEWH_2016\noCEW_Barrage_T3\Output\Flux.mat';
% mod(3).name = 'T3';
% mod(3).color = 'r';

% mod(3).mat = 'D:\Studysites\Lowerlakes\016_newMet_OBS_noAED_W18\Output\Flux.mat';
% mod(3).name = 'obs W10 18 Scaling';
% mod(3).color = 'r';
% 
...
outputdirectory = 'E:\Dropbox\CEW_2016\Results\noCEW_Barrage_T3\Flux Totals 1\';

timeperiod = 2*60*60;

[snum,str] = xlsread('matfiles/Flux Order WQ Ave.xlsx','A2:H50');
...
sites = {'Wellington','Tauwitchere','Ewe','Boundary','Mundoo','Goolwa','Ocean','Coorong_1','Coorong_BC','Murray'};
