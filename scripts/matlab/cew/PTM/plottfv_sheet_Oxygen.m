...
ncfile = 'Z:\Busch\Studysites\Lowerlakes\2019_Modelling\Little_Duck_2018\Output\little_duck.nc';
ptmfile = 'Z:\Busch\Studysites\Lowerlakes\2019_Modelling\Little_Duck_2018\Output_PTM\little_duck_ptm.nc';

outdir = 'Z:\Busch\Studysites\Lowerlakes\2019_Modelling\Little_Duck_2018\Output_PTM\\';
...
[~,intBB] = min(abs(timesteps - datenum(2015,10,06)));

for i = intBB:1:length(timesteps)%1:plot_interval:length(timesteps)
    ...
    if first_plot
        ...
        set(findobj(gca,'type','surface'),...
            ...
            'BackFaceLighting','unlit');hold on
        
        %mapshow(shp,'EdgeColor','k','facecolor','none')
