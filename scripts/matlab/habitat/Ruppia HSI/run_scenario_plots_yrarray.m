...
year_array = 2017;% 2014 2014 2014 2015 2015 2015 2015];%,2015,2015];
...
%     filename = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Output\',scenarios{i},'.nc'];
    filename = ['E:\Lowerlakes\Busch_Ruppia_modeloutput\',scenarios{i},'.nc'];
    ...
    if exist(filename,'file')
        ...
        if f.bytes > min_size
            ...
            outdir_malg_f = ['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\malg\'];
            plottfv_averaged_4_panel_coorong_sheet_inserts_malg_f(filename,outdir_malg_f,year_array(j));
            
            
            % Plots to the sheets directory
            outdir_lim1_f = ['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\1_adult_new\'];
            outdir_lim2_f = ['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\2_flower_new\'];
            outdir_lim3_f = ['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\3_seed_new\'];
            outdir_lim4_f = ['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\4_turion_new\'];
            outdir_lim5_f = ['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\5_sprout_new\'];
            ...
            hsi1= load(['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\1_adult_new\HSI_adult.mat']);
            hsi2= load(['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\2_flower_new\HSI_flower.mat']);
            hsi3= load(['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\3_seed_new\HSI_seed.mat']);
            hsi4= load(['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\4_turion_new\HSI_turion.mat']);
            hsi5= load(['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\5_sprout_new\HSI_sprout.mat']);
            
            
            outdir = ['E:\Lowerlakes\RuppiaHSI\',scenarios{i},'\Sheets\',num2str(year_array(j)),'\'];
