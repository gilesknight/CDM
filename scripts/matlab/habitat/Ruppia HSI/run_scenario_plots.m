...
year_array = [2017 2020];% 2014 2014 2014 2015 2015 2015 2015];%,2015,2015];
...
for i = 1:length(scenarios)
    ...
    filename = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Output\',scenarios{i},'.nc'];
    ...
    if exist(filename,'file')
        ...
        if f.bytes > min_size
            ...
            outdir_malg_f = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\malg\'];
            plottfv_averaged_4_panel_coorong_sheet_inserts_malg_f(filename,outdir_malg_f,year_array(i));
            
            
            % Plots to the sheets directory
            outdir_lim1_f = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\1_adult_new\'];
            outdir_lim2_f = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\2_flower_new\'];
            outdir_lim3_f = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\3_seed_new\'];
            outdir_lim4_f = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\4_turion_new\'];
            outdir_lim5_f = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\5_sprout_new\'];
            ...
            hsi1= load(['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\1_adult_new\HSI_adult.mat']);
            hsi2= load(['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\2_flower_new\HSI_flower.mat']);
            hsi3= load(['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\3_seed_new\HSI_seed.mat']);
            hsi4= load(['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\4_turion_new\HSI_turion.mat']);
            hsi5= load(['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\5_sprout_new\HSI_sprout.mat']);
            
            
            outdir = ['Z:\Busch\Studysites\Lowerlakes\Ruppia\MER_Coorong_eWater_2020_v1\Plotting\',scenarios{i},'\Sheets\',num2str(year_array(i)),'\'];
