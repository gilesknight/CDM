...
function [HSI,fS,fT,fO,fA]=cal_HSI_bream(sal_bot,monthTEMP, Depth)%,do_bot,amm_bot,)
%load swan_WQ.mat;
    ...
    for jj=1:size(sal_bot,2) %time step
        ...
        if Depth(ii,jj)<0.1
            ...
            elseif monthTEMP(ii,jj)<t2
                s10=((82-79)/(23-14))*(monthTEMP(ii,jj)-14)+79;
                s50=((88-85)/(23-14))*(monthTEMP(ii,jj)-14)+85;
            elseif monthTEMP(ii,jj)>=t2
                s10=82;
                s50=88;
            end
