...
function [HSI,fS,fT,fO,fA]=cal_HSI_mullet(sal_bot,monthTEMP, Depth)%,do_bot,amm_bot,)
%load swan_WQ.mat;
    ...
    for jj=1:size(sal_bot,2) %time step
        ...
        if Depth(ii,jj)<0.1
            ...
            elseif monthTEMP(ii,jj)<t2
                s10=((68-84)/(23-14))*(monthTEMP(ii,jj)-14)+84;
                s50=((82-91)/(23-14))*(monthTEMP(ii,jj)-14)+91;
            elseif monthTEMP(ii,jj)>=t2
                s10=68;
                s50=82;
            end
