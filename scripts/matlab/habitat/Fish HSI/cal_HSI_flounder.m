...
function [HSI,fS,fT,fO,fA]=cal_HSI_flounder(sal_bot,monthTEMP, Depth)%,do_bot,amm_bot,)
%load swan_WQ.mat;
    ...
    for jj=1:size(sal_bot,2) %time step
        ...
        if Depth(ii,jj)<0.1
            ...
            elseif monthTEMP(ii,jj)<t2
                s10=((73-81)/(23-14))*(monthTEMP(ii,jj)-14)+81;
                s50=((79-88)/(23-14))*(monthTEMP(ii,jj)-14)+88;
            elseif monthTEMP(ii,jj)>=t2
                s10=73;
                s50=79;
            end
